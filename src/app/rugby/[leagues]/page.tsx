...
import RugbyleagueContainerDynamic from "./components/RugbyleagueContainerDynamic";
const page = () => {
    ...
    console.log(testId, "la ville en question");
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    `http://localhost:3000/rugbyLeagues/${testId}`
                );

                const d = response.data;
                console.log(d, "data of league");
                ...
                <div className='headerContainer'>
                    {leaguesIds.length > 0 ? (
                        <>
                            ...
                            <RugbyleagueContainerDynamic dataLeaguesId={leaguesIds} />
