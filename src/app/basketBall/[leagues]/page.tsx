...
import BsketLeagueContainerDynamic from './components/BsketLeagueContainerDynamic'
const page = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`http://localhost:3000/basketballLeague/${testId}`);
                ...
                <div className='headerContainer'>
                    {leaguesIds.length > 0 ? (
                        <>
                            ...
                            <BsketLeagueContainerDynamic dataLeaguesId={leaguesIds} />
